...
local function hoverEffect(btn, activeBg, inactiveBg, activeStroke, inactiveStroke)
    ...
    local function isStateValid()
        return btn.Text == "Run" or btn.Text == "Copy" or btn.Text == "Verify Key" or btn.Text == "Get Key" or btn.Text == "S"
    end
...
-- Smooth transition helper for changing status texts
...
applyTextGradient(keyTitleText, Color3.fromRGB(145, 80, 255), Color3.fromRGB(0, 240, 200))
...
keySubText.TextColor3 = Color3.fromRGB(140, 140, 150)
...
keyBox.BackgroundColor3 = Color3.fromRGB(24, 24, 26)
keyBox.Text = ""
...
corner(keyBox, 8)
stroke(keyBox, Color3.fromRGB(80, 80, 90), 1)
bindTextBoxFocus(keyBox, Color3.fromRGB(14, 14, 16), Color3.fromRGB(24, 24, 26), Color3.fromRGB(145, 80, 255), Color3.fromRGB(80, 80, 90))

local verifyBtn = Instance.new("TextButton")
verifyBtn.Size = UDim2.new(0, 130, 0, 36)
verifyBtn.Position = UDim2.new(0.5, -140, 0, 155)
verifyBtn.BackgroundColor3 = Color3.fromRGB(120, 55, 210)
...
corner(verifyBtn, 8)
stroke(verifyBtn, Color3.fromRGB(165, 100, 240), 1)

local getKeyBtn = Instance.new("TextButton")
getKeyBtn.Size = UDim2.new(0, 130, 0, 36)
getKeyBtn.Position = UDim2.new(0.5, 10, 0, 155)
getKeyBtn.BackgroundColor3 = Color3.fromRGB(30, 30, 34)
getKeyBtn.Text = "Get Key"
getKeyBtn.TextColor3 = Color3.fromRGB(180, 180, 190)
getKeyBtn.TextSize = 13
getKeyBtn.Font = Enum.Font.GothamBold
getKeyBtn.BorderSizePixel = 0
getKeyBtn.Parent = keyWindow
corner(getKeyBtn, 8)
stroke(getKeyBtn, Color3.fromRGB(80, 80, 90), 1)
...
hoverEffect(verifyBtn, Color3.fromRGB(140, 70, 230), Color3.fromRGB(120, 55, 210), Color3.fromRGB(190, 130, 255), Color3.fromRGB(165, 100, 240))
hoverEffect(getKeyBtn, Color3.fromRGB(40, 40, 44), Color3.fromRGB(30, 30, 34), Color3.fromRGB(145, 80, 255), Color3.fromRGB(80, 80, 90))

-- Decaying spring for wrong key shake animation
local shakeSpring = createSpring(250, 14, 0)

-- Snappy instant positions
...
-- Key Window Dragging Input bindings (Instant direct drag)
...
getKeyBtn.MouseButton1Click:Connect(function()
    ...
    transitionText(infoLabel, "Key link copied to clipboard!", Color3.fromRGB(0, 255, 170))
    task.wait(2)
    if infoLabel.Parent then
        transitionText(infoLabel, "Status: Awaiting verification...", Color3.fromRGB(130, 130, 140))
    end
end)

local function unlockScript()
    transitionText(infoLabel, "Access Granted! Welcome to ShadowX.", Color3.fromRGB(0, 255, 170))
    
    TweenService:Create(keyBox, TweenInfo.new(0.3), {BackgroundColor3 = Color3.fromRGB(15, 35, 25)}):Play()
    ...
    -- Snap directly, let the size tween handle the pop
...
verifyBtn.MouseButton1Click:Connect(function()
    if keyBox.Text == REQUIRED_KEY then
        ...
        transitionText(infoLabel, "Access Denied! Invalid Key.", Color3.fromRGB(255, 80, 120))
        
        -- Kick the shake spring velocity
        ...
        TweenService:Create(keyBox, TweenInfo.new(0.2), {BackgroundColor3 = Color3.fromRGB(50, 20, 25)}):Play()
...
logArea.Size = UDim2.new(1, -12, 1, -(titleBarHeight + 12))
