[Mercury Lib Documentation.txt](https://github.com/user-attachments/files/26446057/Mercury.Lib.Documentation.txt)
## Loadstring
```lua
local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/DozeIsOkLol/UILibarys/refs/heads/main/UILibrarys/MercuryLib/Source.lua"))()
```
