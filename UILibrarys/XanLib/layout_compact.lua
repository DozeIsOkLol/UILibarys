...
Visuals:AddParagraph("Crosshair Styles", "Supports: None, Dot, Small Cross, Cross, Open Cross, Circle, and Icon")
...
Settings:AddParagraph("About", "This is a demonstration of the Compact layout. Smaller footprint, perfect for mobile or lower resolutions.")
...
print("xan.bar Compact Layout loaded!")
