...
function GENOUI:CreateWindow(options)
    ...
    self.Subtitle = options.Subtitle or "GENOUIII"
...
do
    ...
    Window:AddBadge("DEV",        Color3.fromRGB(255, 80, 80))     -- bright red
	Window:AddBadge("TESTING",    Color3.fromRGB(255, 200, 0))    -- yellow
	Window:AddBadge("Private",  Color3.fromRGB(220, 60, 60))
	Window:AddBadge("v0.3",     Color3.fromRGB(0, 170, 255))
    ...
    MiscTab:AddButton({
        Name = "Hello ",
        Callback = function()
            print(" with love - GENO UI v0.1 BETA!")
        end
    })
    
    MiscTab:AddParagraph({
        Text = "GENO UI -  custom library"
    })
    ...
    SettingsTab:AddDropdown({
        Name = "Theme",
        Options = {"Dark", "Neon", "Red & White"},
        Callback = function(choice)
            print("Theme changed to:", choice)
        end
    })
    
    print("GENO UI v0.1 BETA loaded successfully!")
end
