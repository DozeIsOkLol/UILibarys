--[[
    Unveil UI - A Standalone UI Library (V1.3)
    All-in-One Script with Example Usage.
    
    - V1.3 FIX: Added a safety check to prevent errors when a button is created without a callback function. This resolves the final 'attempt to index nil with Text' error.
...
function UnveilUI:AddButton(opts)
    ...
    -- V1.3 FIX: Safely connect the callback only if it's a function
...
Window:AddLabel({
    text = "Created with Unveil UI v1.3",
    align = Enum.TextXAlignment.Center,
    textSize = 12,
