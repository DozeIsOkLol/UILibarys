local UILibrary = loadstring(game:HttpGet("https://raw.githubusercontent.com/DozeIsOkLol/UILibarys/refs/heads/main/UILibrarys/TwinkLibV2/v0.0.2/Source.lua"))()

local UI = UILibrary.Load("Twink UI", "Game Name", "v0.0.2")
