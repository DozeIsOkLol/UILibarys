...
local UILib = loadstring(game:HttpGet('https://raw.githubusercontent.com/DozeIsOkLol/UILibarys/refs/heads/main/UILibrarys/KinxLib/Source.lua'))()

local win = UILib:Window("Kinx Lib",Color3.fromRGB(44, 120, 224), Enum.KeyCode.RightControl)
