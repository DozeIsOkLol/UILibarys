...
local UI = UILibrary.Load("OxBlood", "Demo Game", "v1.0.0", {
    Letter = "Nil",
})
...
Home.AddSection("Welcome to OxBlood")

Home.AddLabel("OxBlood UI  v1.0.0  —  Demo Script")
...
ESP.AddColourPicker("ESP Colour", Color3.fromRGB(160, 20, 40), function(colour)
...
local VersionInfo  = Settings.AddTextInfo("Library Version: v1.0.0")
...
-- ================================================================
--  DONE — all OxBlood features demonstrated!
-- ================================================================
print("[OxBlood UI Demo] Loaded successfully")
