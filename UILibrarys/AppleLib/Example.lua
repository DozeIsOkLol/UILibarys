local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/DozeIsOkLol/UILibarys/refs/heads/main/UILibrarys/AppleLib/Source.lua"))()


local window = library:init("AppleLib", true, Enum.KeyCode.RightShift, true)
