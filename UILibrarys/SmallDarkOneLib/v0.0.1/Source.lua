--[[
	SmallDarkOneLib
	================
	A dark, horrorcore-inspired Roblox UI library.

	Aesthetic direction: blood red & black ("Bloodmoon") with an eerie violet
	alt-theme ("Voidspider"), dripping horror-poster display type, and a
	distressed typewriter accent font — built around the visual world of
	horrorcore / trap-metal album art (think: cartoon villain menace, not
	literal gore).

	Version: 1.0.0
	No external image assets required — everything is drawn with UICorner /
	UIStroke / UIGradient, so it works instantly off a raw GitHub loadstring.

	USAGE (see example.lua for a full walkthrough):
		local SmallDarkOneLib = loadstring(game:HttpGet("RAW_GITHUB_URL_HERE"))()
...
--// ============================ CONFIG (optional, executor-only persistence) ============================
