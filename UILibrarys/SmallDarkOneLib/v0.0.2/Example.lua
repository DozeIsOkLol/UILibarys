--[[
	================================================================================
	 SmallDarkOneLib — example.lua                                        v1.0.0
	================================================================================
...
local REPO_RAW_URL = "https://raw.githubusercontent.com/DozeIsOkLol/UILibarys/refs/heads/main/UILibrarys/SmallDarkOneLib/v0.0.2/Source.lua"
...
local Window = SmallDarkOneLib:CreateWindow({
	...
	Subtitle      = "SmallDarkOneLib v1.0.0",
