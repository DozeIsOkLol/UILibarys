--[[
╔══════════════════════════════════════════════════════════════╗
║                  NexusLib  v0.9 ENHANCED                     ║
║  Quick() · UnloadKey · Slider Suffix · AddParagraph          ║
║  Tab shortcuts (Combat, Visuals, Misc, Settings…)           ║
║  AddResetButton · Modal Dialogs · Dependencies               ║
║  Dropdown/MultiDropdown scroll · MaxHeight · TriggerWidth    ║
╚══════════════════════════════════════════════════════════════╝
...
function NexusLib:CreateWindow(opts)
    ...
    function WindowObj:AddTab(tOpts)
        ...
        function TabObj:AddParagraph(o) return TabObj.AddParagraphToFrame(self, o, scrollFrame, allElements) end
        ...
        -- Reset to defaults button (calls LoadProfile("Default"))
        function TabObj.AddResetButtonToFrame(_, opts, tf, elList)
            ...
            return TabObj.AddButtonToFrame(nil, {
                ...
                Callback = function() LoadProfile("Default"); if opts.Notify ~= false then NexusLib:Notify(opts.Message or "Reset to defaults.") end end,
            }, tf, elList)
        end
...
function NexusLib:Quick(title, tabName, icon)
    ...
    icon = icon or ""
    local Win = self:CreateWindow({ Title = title, Subtitle = "v0.9" })
