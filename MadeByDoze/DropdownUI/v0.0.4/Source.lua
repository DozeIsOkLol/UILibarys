...
Library.ConfigData = {}
Library.Flags = {}
Library.ThemeElements = {} -- Store all elements for theme updates
...
function Library:SetTheme(themeName)
    ...
    -- Update all stored theme elements
    for _, elementData in pairs(Library.ThemeElements) do
        if elementData.Object and elementData.Object.Parent then
            ...
            elseif elementType == "SecondaryFrame" then
                obj.BackgroundColor3 = Config.SecondaryColor
            elseif elementType == "AccentLine" then
                obj.BackgroundColor3 = Config.AccentColor
            elseif elementType == "Text" then
                obj.TextColor3 = Config.TextColor
            elseif elementType == "AccentText" then
                obj.TextColor3 = Config.AccentColor
            elseif elementType == "ToggleOn" then
                -- Only update if currently on
                if obj.BackgroundColor3 == Library.Themes.Dark.ToggleOn or 
                   obj.BackgroundColor3 == Library.Themes.Light.ToggleOn or
                   obj.BackgroundColor3 == Library.Themes.Ocean.ToggleOn or
                   obj.BackgroundColor3 == Library.Themes.Forest.ToggleOn or
                   obj.BackgroundColor3 == Library.Themes.Sunset.ToggleOn then
                    obj.BackgroundColor3 = Config.ToggleOn
                end
            elseif elementType == "ToggleOff" then
                -- Only update if currently off
                if obj.BackgroundColor3 == Library.Themes.Dark.ToggleOff or 
                   obj.BackgroundColor3 == Library.Themes.Light.ToggleOff or
                   obj.BackgroundColor3 == Library.Themes.Ocean.ToggleOff or
                   obj.BackgroundColor3 == Library.Themes.Forest.ToggleOff or
                   obj.BackgroundColor3 == Library.Themes.Sunset.ToggleOff then
                    obj.BackgroundColor3 = Config.ToggleOff
                end
            elseif elementType == "SliderFill" then
                obj.BackgroundColor3 = Config.AccentColor
            elseif elementType == "GradientLine" then
...
function Library:CreateWindow(windowName, toggleKey)
    ...
    Library:RegisterThemeElement(TitleBar, "SecondaryFrame")
    ...
    Library:RegisterThemeElement(AccentLine, "AccentLine")
    ...
    Library:RegisterThemeElement(AccentGradient, "GradientLine")
    ...
    Library:RegisterThemeElement(TitleLabel, "Text")
    ...
    Library:RegisterThemeElement(ToggleButton, "Text")
    ...
    function Window:CreateDropdown(dropdownName)
        ...
        Library:RegisterThemeElement(DropdownFrame, "SecondaryFrame")
        ...
        Library:RegisterThemeElement(DropdownHeader, "Text")
        ...
        Library:RegisterThemeElement(DropdownArrow, "AccentText")
        ...
        Library:RegisterThemeElement(DropdownContent, "MainFrame")
        ...
        function Dropdown:AddButton(buttonName, callback)
            ...
            Library:RegisterThemeElement(Button, "SecondaryFrame")
            ...
            Library:RegisterThemeElement(ButtonText, "Text")
        ...
        function Dropdown:AddDropdownSelector(selectorName, options, default, callback)
            ...
            Library:RegisterThemeElement(SelectorFrame, "SecondaryFrame")
            ...
            Library:RegisterThemeElement(SelectorLabel, "Text")
            ...
            Library:RegisterThemeElement(SelectorButton, "MainFrame")
            ...
            Library:RegisterThemeElement(Arrow, "AccentText")
            
            -- Create options frame as direct child of ScreenGui for proper layering
            local OptionsFrame = CreateInstance("Frame", {
                Name = "Options_" .. selectorName,
            ...
            Library:RegisterThemeElement(OptionsFrame, "MainFrame")
            ...
            local OptionsStroke = CreateInstance("UIStroke", {
                Parent = OptionsFrame,
                Color = Config.AccentColor,
                Thickness = 1,
                Transparency = 0.5
            })
            Library:RegisterThemeElement(OptionsStroke, "Stroke")
            ...
            for _, option in ipairs(options) do
                ...
                Library:RegisterThemeElement(OptionButton, "SecondaryFrame")
                ...
                Library:RegisterThemeElement(OptionText, "Text")
            ...
            local function UpdateOptionsPosition()
                ...
                OptionsFrame.Position = UDim2.new(0, buttonPos.X, 0, buttonPos.Y + buttonSize.Y + 2)
            end
            ...
            UserInputService.InputBegan:Connect(function(input)
                if input.UserInputType == Enum.UserInputType.MouseButton1 then
                    ...
                    if isOpen and not clickedButton and not clickedOptions then
                        isOpen = false
                        OptionsFrame.Visible = false
                        Tween(OptionsFrame, {Size = UDim2.new(0, 65, 0, 0)}, 0.2)
                        Tween(Arrow, {Rotation = 0}, 0.2)
            ...
            -- Update position when window is dragged
