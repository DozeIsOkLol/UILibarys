# Custom Roblox UI Library v0.0.4
...
### v2.0.2 (Latest) ⭐ MAJOR FIXES
- 🐛 **FIXED: Dropdown selectors now appear on top of everything**
  - Moved dropdown options to ScreenGui directly for proper layering
  - Added z-index 1000+ for dropdowns
  - Implemented click-outside-to-close functionality
  - Auto-updates position when window is dragged
- 🐛 **FIXED: Theme system now updates ALL elements instantly**
  - Completely rewritten theme registration system
  - All elements register themselves when created
  - Instant theme changes with no lag
  - Updates frames, text, gradients, strokes, everything!
- ✅ Enhanced dropdown visibility with UIStroke borders
- ✅ Better element categorization for theme system
- ✅ Performance optimizations

### v2.0.1
- 🐛 Fixed dropdown selectors appearing behind other UI elements (partial fix)
- 🐛 Fixed theme system not updating existing UI elements (partial fix)
